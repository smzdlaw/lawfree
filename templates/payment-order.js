...
const PaymentOrderTemplate = {
  ...
  renderDateNumber(value) {
    ...
    return `
      <span
        class="doc-preview__date-num doc-preview__date-num--empty"
      ></span>
    `;
  },
    ...
    return `
      <div class="doc-preview__date-line">
        ...
        <div class="doc-preview__date-row">
          ...
          <span class="doc-preview__date-prefix">
            中華民國
          </span>

          ${this.renderDateNumber(year)}

          <span class="doc-preview__date-unit">
            年
          </span>
    ...
    if (this.hasValue(party.idNumber)) {
      ...
      lines.push(
        ...
        `<p class="doc-preview__line">
          ...
          身分證字號：${this.escapeHtml(String(party.idNumber).trim())}
    ...
    if (party.birthDate) {
      ...
      lines.push(
        ...
        `<p class="doc-preview__line">
          ...
          出生年月日：${this.formatRocDate(party.birthDate)}
    ...
    if (this.hasValue(party.address)) {
      ...
      lines.push(
        ...
        `<p class="doc-preview__line">
          ...
          住、居所：${this.escapeHtml(String(party.address).trim())}
    ...
    if (this.hasValue(party.phone)) {
      ...
      lines.push(
        ...
        `<p class="doc-preview__line">
          ...
          電　　話：${this.escapeHtml(String(party.phone).trim())}
  ...
  renderClaimItem(claim) {
    ...
    if (hasRate && hasDate) {
      ...
      return `一、相對人應給付聲請人新臺幣${amount}元，及自${this.formatRocDate(
    ...
    if (hasRate) {
      ...
      return `一、相對人應給付聲請人新臺幣${amount}元，及按年利率百分之${this.val(
        String(claim.interestRate),
        "　　"
      )}計算之利息。`;
  ...
  formatCourt(court) {
    ...
    if (!court || !String(court).trim()) {
      ...
      return `<span class="doc-preview__court-placeholder">
  ...
  getAttachmentPreviewText(id, attachments) {
    ...
    return `
      <div class="doc-preview__block doc-preview__attachments">
        ...
        <p class="doc-preview__line doc-preview__line--label">
          附件：
        </p>
  ...
  render(data) {
    ...
    const reason =
      claim.reason && String(claim.reason).trim()
        ? this.escapeHtml(String(claim.reason).trim())
        : "（請敘述請求原因及事實）";
    ...
    return `
      ...
      <div class="doc-preview">
        ...
        <div class="doc-preview__block">
          ...
          <p class="doc-preview__line doc-preview__line--indent doc-preview__reason">
        ...
        <div class="doc-preview__footer">
          ...
          <p class="doc-preview__line doc-preview__court">

            ${this.formatCourt(claim.court)}　公鑒
